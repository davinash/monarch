...
public class ORCConverterDescriptor implements ConverterDescriptor {

  private List<ColumnConverterDescriptor> columnConverters = new ArrayList<>();

  public ORCConverterDescriptor(TableDescriptor tableDescriptor) {
    for (final MColumnDescriptor mColumnDescriptor : tableDescriptor.getAllColumnDescriptors()) {
      ColumnConverterDescriptor columnConvertorDescriptor = new ORCColumnConverterDescriptor(
