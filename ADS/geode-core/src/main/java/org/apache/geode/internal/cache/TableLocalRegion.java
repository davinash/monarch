...
public class TableLocalRegion extends LocalRegion {
  private static final Logger logger = LogService.getLogger();

  protected TableLocalRegion(String regionName, RegionAttributes attrs, LocalRegion parentRegion,
        ...
        synchronized (this.subregionsLock) {
          ...
          if (existing == null) {
            if (regionAttributes.getScope().isDistributed()
              ...
              } else if (AmpoolTableRegionAttributes.isAmpoolMTable(this.getCustomAttributes())) {
                newRegion = new MTableBucketRegion(subregionName, regionAttributes, this,
                    this.cache, internalRegionArgs);
              }
            } else if (regionAttributes.getPartitionAttributes() != null) {
              newRegion = new TableRegion(subregionName, regionAttributes, this, this.cache,
                  internalRegionArgs);
            } else {
