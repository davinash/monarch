...
public abstract class UserSpecifiedRegionAttributes<K, V> implements RegionAttributes<K, V> {
  ...
  private boolean hasRegionMapFactory = false;
  ...
  public boolean hasRegionMapFactory() {
    return this.hasRegionMapFactory;
  }

  public void setHasRegionMapFactory(boolean hasRegionMapFactory) {
    this.hasRegionMapFactory = hasRegionMapFactory;
  }
  ...
  public void setHasCustomAttributes(boolean customAttributes) {
    this.hasCustomAttributes = customAttributes;
  }
}
