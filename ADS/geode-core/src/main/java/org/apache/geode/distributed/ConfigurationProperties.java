...
public interface ConfigurationProperties {
   ...
   * when it is {@linkplain CacheFactory#create created}. Create will first look for a file that
   * matches the value of this property. If a file is not found then it will be searched for using
   * {@link java.lang.ClassLoader#getResource}. If the value of this property is the empty string
   * (<code>""</code>), then the cache will not be declaratively initialized.
   * </p>
