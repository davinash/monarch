...
public class GatewaySenderAttributes {
  ...
  public List<MAsyncEventListener> mlisteners = new ArrayList<MAsyncEventListener>();

  public void addMAsyncEventListener(MAsyncEventListener listener) {
    this.mlisteners.add(listener);
  }

  public List<MAsyncEventListener> getMAsyncEventListeners() {
