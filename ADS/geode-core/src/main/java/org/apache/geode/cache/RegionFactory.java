...
public class RegionFactory<K, V> {
  ...
  public RegionFactory<K, V> setRegionMapFactory(String regionMapFactory) {
    this.attrsFactory.setRegionMapFactory(regionMapFactory);
    return this;
  }

  public RegionFactory<K, V> setCustomAttributes(final CustomRegionAttributes customAttributes) {
    this.attrsFactory.setCustomAttributes(customAttributes);
    return this;
  }
}
