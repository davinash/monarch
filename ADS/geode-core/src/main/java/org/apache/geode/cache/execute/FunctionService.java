...
public class FunctionService {
  ...
  public static Execution onMTable(MTable table) {
    return functionSvcMgr.onMTable(table);
  }

  public static void registerFunction(String id, Function function) {
    functionSvcMgr.registerFunction(id, function);
  }
}
