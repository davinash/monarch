      ...
      switch (opCode) {
        ...
        case DiskInitFile.IFREC_REGION_CONFIG_ID_66: {
          ...
          interpreter.cmnRegionConfig(drId, lruAlgorithm, lruAction, lruLimit, concurrencyLevel,
              ...
              startingBucketId, null, false, null, null);
        }
          break;
        case DiskInitFile.IFREC_REGION_CONFIG_ID_80: {
          ...
          interpreter.cmnRegionConfig(drId, lruAlgorithm, lruAction, lruLimit, concurrencyLevel,
              initialCapacity, loadFactor, statisticsEnabled, isBucket, flags, partitionName,
              startingBucketId, compressorClassName, false, null, null);
        }
          break;
        case DiskInitFile.IFREC_REGION_CONFIG_ID_90: {
          ...
          String regionMapFactory = dis.readUTF();
          boolean hasCustomAttributes = dis.readBoolean();
          CustomRegionAttributes customAttributes = null;
          if (hasCustomAttributes) {
            customAttributes = DataSerializer.readObject(dis);
          }
          ...
          interpreter.cmnRegionConfig(drId, lruAlgorithm, lruAction, lruLimit, concurrencyLevel,
              initialCapacity, loadFactor, statisticsEnabled, isBucket, flags, partitionName,
              startingBucketId, compressorClassName, offHeap, regionMapFactory, customAttributes);
        }
          break;
