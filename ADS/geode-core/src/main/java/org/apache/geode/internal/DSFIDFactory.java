...
import io.ampool.store.internal.RequestStoreImageMessage;
import io.ampool.store.internal.StoreImageReplyMessage;
...
public final class DSFIDFactory implements DataSerializableFixedID {
  ...
  private static void registerDSFIDTypes() {
    ...
    registerDSFID(AMPL_MTABLE_RGN_CREATE_ARGS, MCreateFunctionArguments.class);
    registerDSFID(AMPL_MOPINFO, MOpInfo.class);
    registerDSFID(AMPL_MVALUE, MValue.class);
    registerDSFID(AMPL_MKEYBASE, MKeyBase.class);
    registerDSFID(AMPL_MCONDITION, MOpInfo.MCondition.class);
    registerDSFID(AMPL_M_PART_LIST, MPartList.class);
    registerDSFID(AMPL_FTABLEKEY, FTableKey.class);
    registerDSFID(AMPL_M_PARTITION_RESOLVER, MPartitionResolver.class);
    registerDSFID(AMPL_FTABLE_BLOCKKEY, BlockKey.class);
    registerDSFID(AMPL_FTABLE_BLOCKVALUE, BlockValue.class);
    registerDSFID(AMPL_STORE_IMAGE_REQ, RequestStoreImageMessage.class);
    registerDSFID(AMPL_STORE_IMAGE_RES, StoreImageReplyMessage.class);
    /*
     * using DataSerializableFixedID causes test failures in SessionReplicationIntegrationJUnitTest
     */
    // registerDSFID(AMPL_M_RANGE_PART_RESOLVER, MTableRangePartitionResolver.class);
    registerDSFID(AMPL_MTABLE_MULTIVERSION_VALUE, MultiVersionValue.class);
  }
