 ...
 * <p>
 *
 * Each {@link Cache} defines a single top region called the root region. User applications can use
 * the root region to create subregions for isolated name space and object grouping.
 * <p>
 *
