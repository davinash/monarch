...
public class AsyncEventQueueImpl implements AsyncEventQueue {
  ...
  private MAsyncEventListener mAsyncEventListener = null;

  public AsyncEventQueueImpl(GatewaySender sender, MAsyncEventListener eventListener) {
    this.sender = sender;
    this.mAsyncEventListener = eventListener;
  }
}
