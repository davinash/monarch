...
public class CacheDistributionAdvisor extends DistributionAdvisor {
  ...
  private static final int REGIONMAP_FATORY_MASK = 0x40000;
  ...
  private static final int HAS_CUSTOM_ATTRIBUTES = 0x2000000;
  ...
  public static class CacheProfile extends DistributionAdvisor.Profile {
    ...
    public String regionMapFactory = null;
    public CustomRegionAttributes customRegionAttributes = null;
    ...
    protected int getIntInfo() {
      ...
      if (this.isOffHeap)
        s |= IS_OFF_HEAP_MASK;
      if (this.regionMapFactory != null)
        s |= REGIONMAP_FATORY_MASK;
      if (this.customRegionAttributes != null)
        s |= HAS_CUSTOM_ATTRIBUTES;
    ...
    // AMPOOL CHANGES START
    private boolean hasRegionMapFactory(int bits) {
      return (bits & REGIONMAP_FATORY_MASK) != 0;
    }

    private boolean hasCustomAttributes(int bits) {
      return (bits & HAS_CUSTOM_ATTRIBUTES) != 0;
    }
    ...
    public void toData(DataOutput out) throws IOException {
      ...
      if (regionMapFactory != null) {
        DataSerializer.writeString(regionMapFactory, out);
      }

      if (customRegionAttributes != null) {
        DataSerializer.writeObject(customRegionAttributes, out);
      }
    }
    ...
    public void fromData(DataInput in) throws IOException, ClassNotFoundException {
      ...
      if (hasRegionMapFactory(bits)) {
        regionMapFactory = DataSerializer.readString(in);
      }

      if (hasCustomAttributes(bits)) {
        customRegionAttributes = DataSerializer.readObject(in);
      }
    ...
    public void fillInToString(StringBuilder sb) {
      ...
      sb.append("; regionMapFactory=" + this.regionMapFactory);
      sb.append("; CustomRegionAttributes=" + this.customRegionAttributes);
