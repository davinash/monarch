...
public class DistributedRegion extends LocalRegion implements CacheDistributionAdvisee {
  ...
  public void fillInProfile(Profile p) {
    ...
    profile.customRegionAttributes = getCustomAttributes();
  ...
  protected Object findObjectInSystem(KeyInfo keyInfo, boolean isCreate, TXStateInterface txState,
    ...
    try {
      ...
      if (preferCD) {
        ...
        //
        // // if (this.getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_ORDERED_VERSIONED
        // // || this.getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_UNORDERED) {
        // result = event.getAmpoolValue();
        // } else {
        result = event.getRawNewValueAsHeapObject();
        // }
      } else {
        // if (isCreate && (this.getCustomAttributes()
        // .getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_UNORDERED
        // || this.getCustomAttributes()
        // .getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_ORDERED_VERSIONED)) {
        //
        // // if (isCreate && (this.getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_UNORDERED
        // // || this.getRegionDataOrder() == RegionDataOrder.ROW_TUPLE_ORDERED_VERSIONED)) {
        // result = event.getAmpoolValue();
        // } else {
