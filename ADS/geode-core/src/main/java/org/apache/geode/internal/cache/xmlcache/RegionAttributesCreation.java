...
public class RegionAttributesCreation extends UserSpecifiedRegionAttributes
  ...
  private String regionMapFactory;
  ...
  public RegionAttributesCreation(CacheCreation cc, RegionAttributes attrs, boolean defaults) {
    ...
    this.regionMapFactory = attrs.getRegionMapFactory();
    this.customAttributes = attrs.getCustomAttributes();
  ...
  public boolean sameAs(RegionAttributes other) {
    ...
    if (!StringUtils.compare(this.regionMapFactory, other.getRegionMapFactory())) {
      throw new RuntimeException(
          LocalizedStrings.RegionAttributesCreation_REGION_MAP_FACTORY_IS_NOT_THE_SAME
              .toLocalizedString());
    }

    if (!CustomRegionAttributes.compare(customAttributes, getCustomAttributes())) {
      throw new RuntimeException(
          LocalizedStrings.RegionAttributesCreation_CUSTOM_ATTRIBUTES_NOT_THE_SAME
              .toLocalizedString());
    }
    return true;
  }
