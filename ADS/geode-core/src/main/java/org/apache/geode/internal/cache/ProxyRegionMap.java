 ...
 * 
 */
final public class ProxyRegionMap implements RegionMap {

  public ProxyRegionMap(LocalRegion owner, Attributes attr,
  ...
  @Override
  public Object getInternalMap() {
    throw new IllegalStateException("getStartKey should never be called on proxy");
  }

  @Override
  public Pair<Object, Object> getStartEndKey() {
    throw new IllegalStateException("getStartEndKey should never be called on proxy");
  }
}
