...
public class CliStrings {
  ...
  public static final String START_LOCATOR__RUN_MESSAGE = "Starting a Ampool Locator in %1$s...";
  ...
  public static final String START_SERVER__TIER__CLASSPATH = "tier-classpath";
  public static final String START_SERVER__TIER__CLASSPATH__HELP =
      "Location of tier store classes required by the Server. The tier store classpath is prepended to the Server's classpath. This option is deprecated, alternatively use --ext-classpath.";
  ...
  public static final String START_SERVER__RUN_MESSAGE = "Starting a Ampool Server in %1$s...";
