...
public abstract class AbstractDiskRegion implements DiskRegionView {
  ...
  private String regionMapFactory = null;
  ...
  protected AbstractDiskRegion(DiskStoreImpl ds, String name) {
    ...
    if (drv != null) {
      ...
      this.regionMapFactory = drv.getRegionMapFactory();
      this.customAttributes = drv.getCustomAttributes();
  ...
  public void dump(PrintStream printStream) {
    ...
    msg += " -concurrencyLevel=" + getConcurrencyLevel() + " -initialCapacity="
        ...
        + " -statisticsEnabled=" + getStatisticsEnabled() + " -customAttrributes="
        + CustomRegionAttributes.getString(getCustomAttributes()) + " -regionMapFactory="
        + getRegionMapFactory();
  ...
  public String dump2() {
    ...
    sb.append(lineSeparator);
    sb.append("-regionMapFactory=" + getRegionMapFactory());
    sb.append(lineSeparator);
  ...
  public void dumpCommonAttributes(StringBuilder msg) {
    ...
    msg.append("\n\tCustomAttributes=").append(getCustomAttributes());
    msg.append("\n\tregionMapFactory=").append(getRegionMapFactory());
