...
public class ServerConnection implements Runnable {
  ...
  private ChunkedStreamMessage chunkedStreamResponseMsg =
      new ChunkedStreamMessage(1, Version.CURRENT);
  ...
  private void initStreams(Socket s, int socketBufferSize, MessageStats msgStats) {
    try {
      ...
      chunkedStreamResponseMsg.setComms(this, theSocket, commBuffer, msgStats);
  ...
  /**
   * @return The ChunkedStreamResponseMessage associated with the ServerConnection
   */
  public ChunkedStreamMessage getChunkedStreamResponseMessage() {
    return this.chunkedStreamResponseMsg;
  }
