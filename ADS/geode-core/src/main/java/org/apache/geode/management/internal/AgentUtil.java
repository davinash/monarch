...
public class AgentUtil {
  ...
  public String findWarLocation(String warFilePrefix) {
    ...
    if (!StringUtils.isBlank(geodeHome)) {
      String[] possibleFiles =
          {geodeHome + "/tools/Extensions/" + warFilePrefix + "-" + gemfireVersion + ".war",
              ...
              geodeHome + "/tools/Extensions/" + warFilePrefix + "-" + ampoolVersion + ".war",
              geodeHome + "/tools/Pulse/" + warFilePrefix + "-" + ampoolVersion + ".war",
              geodeHome + "/lib/" + warFilePrefix + "-" + ampoolVersion + ".war",
              geodeHome + "/lib/" + warFilePrefix + "-" + ampoolVersion + ".war",
              geodeHome + "/extensions/" + warFilePrefix + "-" + ampoolVersion + ".war",
              geodeHome + "/extensions/" + warFilePrefix + ".war"
    ...
    String[] possibleFiles = {warFilePrefix + "-" + ampoolVersion + ".war",
        /** try <project>/build/libs path for possible war files.. **/
        "libs/" + warFilePrefix + "-" + ampoolVersion + ".war",
        "tools/Pulse/" + warFilePrefix + "-" + ampoolVersion + ".war",
        "tools/Extensions/" + warFilePrefix + "-" + ampoolVersion + ".war",
        "lib/" + warFilePrefix + "-" + ampoolVersion + ".war",
