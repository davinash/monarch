...
public interface PdxReader {
   ...
   * <P>
   * Note that if {@link CacheFactory#setPdxIgnoreUnreadFields(boolean) setPdxIgnoreUnreadFields} or
   * {@link ClientCacheFactory#setPdxIgnoreUnreadFields(boolean) client setPdxIgnoreUnreadFields}
   * are set to <code>true</code> then this method will always return an object that has no unread
   * fields.
   *
