...
public class MBeanJMXAdapter implements ManagementConstants {
  ...
  public static ObjectName getTierStoreMBeanName(DistributedMember member, String tierName) {
    return getObjectName((MessageFormat.format(OBJECTNAME__TIERSTORE_MXBEAN,
        new Object[] {tierName, getMemberNameOrId(member)})));
  }
