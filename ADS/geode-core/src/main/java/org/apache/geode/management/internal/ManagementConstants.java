...
public interface ManagementConstants {
  ...
  public static final String OBJECTNAME__TIERSTORE_MXBEAN =
      OBJECTNAME__PREFIX + "service=TierStore,name={0},type=Member,member={1}";
  ...
  /* AMPOOL RELATED CHANGES START */
  public static final String TIER_STORE_CREATED_PREFIX = "Tiertore Created With Name ";;
  /* AMPOOL RELATED CHANGES END */
}
