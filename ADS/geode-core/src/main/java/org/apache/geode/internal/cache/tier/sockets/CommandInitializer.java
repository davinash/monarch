...
import org.apache.geode.internal.cache.tier.sockets.command.*;
...
public class CommandInitializer {
  ...
  private static void initializeAllCommands() {
    ...
    }
    {
      ...
      gfe91Commands.put(MessageType.GET_CLIENT_PARTITION_ATTRIBUTES,
          GetClientPartitionAttributesCommand91.getCommand());
