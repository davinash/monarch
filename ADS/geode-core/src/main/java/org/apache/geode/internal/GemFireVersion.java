...
public class GemFireVersion {
  ...
  public static String getAmpoolVersion() {
    return getDescription().getProperty(VersionDescription.AMPOOL_VERSION);
  }
  ...
  public static String getAmpoolJarFileName() {
    return "monarch-" + GemFireVersion.getAmpoolVersion() + ".jar";
  }
  ...
  public static URL getJarURL() {
    ...
    while (tokenizer.hasMoreTokens()) {
      ...
      if (jar.indexOf(getAmpoolJarFileName()) != -1) {
  ...
  static class VersionDescription {
    ...
    /**
     * Constant for the Ampool version Resource Property entry
     */
    private static final String AMPOOL_VERSION = "Ampool-Version";
