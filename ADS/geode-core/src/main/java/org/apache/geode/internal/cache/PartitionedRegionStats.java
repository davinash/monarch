...
public class PartitionedRegionStats {
  ...
  private final static int scanCountId;
  ...
  static {
    ...
    type = f.createType("PartitionedRegionStats",
        ...
        new StatisticDescriptor[] {
            ...
            f.createIntGauge("scanCount", "Number of scans done in this node.", "scans"),
    ...
    scanCountId = type.nameToId("scanCount");
  ...
  public void incScanCount(int delta) {
    this.stats.incInt(scanCountId, delta);
  }

  public void setScanCount(int i) {
    this.stats.setInt(scanCountId, i);
  }

  public int getTotalScanCount() {
    return this.stats.getInt(scanCountId);
  }
