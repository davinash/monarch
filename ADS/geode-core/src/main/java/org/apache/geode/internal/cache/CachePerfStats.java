...
public class CachePerfStats {
  ...
  protected static final int scansId;
  ...
  static {
    ...
    final String scansDesc =
        "The total number of times a successful scan has been done on this cache.";
    ...
    type = f.createType("CachePerfStats", "Statistics about GemFire cache performance",
        new StatisticDescriptor[] {
            ...
            f.createIntCounter("scans", scansDesc, "operations"),
  ...
  public int getScansId() {
    return stats.getInt(scansId);
  }
