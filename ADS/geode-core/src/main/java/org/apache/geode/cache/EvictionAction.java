...
public final class EvictionAction extends EnumSyntax {
  ...
  /**
   * Write both key and value to external tier and destroy the memory entry to keep memory footprint
   * constant even for very large data where size of keys itself would be greater than heap and
   * cannot be completely stored in-memory.
   */
  public static final EvictionAction OVERFLOW_TO_TIER = new EvictionAction(3);
  ...
  private static final String[] stringTable =
      {"none", "local-destroy", "overflow-to-disk", "overflow-to-tier",
  ...
  private static /* final */ EvictionAction[] enumValueTable =
      {NONE, LOCAL_DESTROY, OVERFLOW_TO_DISK, OVERFLOW_TO_TIER
  ...
  public final boolean isOverflowToTier() {
    return this == OVERFLOW_TO_TIER;
  }
