...
public class AttributesFactory<K, V> {
  ...
  public AttributesFactory(RegionAttributes<K, V> regionAttributes) {
    ...
    this.regionAttributes.regionMapFactory = regionAttributes.getRegionMapFactory();
    this.regionAttributes.customAttributes = regionAttributes.getCustomAttributes();
  }
  ...
  public void setPartitionAttributes(PartitionAttributes partition) {
    if (partition != null) {
      ...
      ((PartitionAttributesImpl) this.regionAttributes.partitionAttributes)
          .setRegionMapFactory(this.regionAttributes.regionMapFactory);
      ((PartitionAttributesImpl) this.regionAttributes.partitionAttributes)
          .setCustomAttributes(this.regionAttributes.customAttributes);
  ...
  public void setRegionMapFactory(String regionMapFactory) {
    this.regionAttributes.regionMapFactory = regionMapFactory;
    this.regionAttributes.setHasRegionMapFactory(true);

    if (this.regionAttributes.partitionAttributes != null) {
      ((PartitionAttributesImpl) this.regionAttributes.partitionAttributes)
          .setRegionMapFactory(regionMapFactory);
    }
  }

  public void setCustomAttributes(final CustomRegionAttributes customAttributes) {
    this.regionAttributes.customAttributes = customAttributes;
    this.regionAttributes.setHasCustomAttributes(true);
  ...
  public RegionAttributes<K, V> create() {
    if (this.regionAttributes.hasDataPolicy() && this.regionAttributes.dataPolicy.withPartitioning()
      ...
      ((PartitionAttributesImpl) this.regionAttributes.partitionAttributes)
          .setRegionMapFactory(this.regionAttributes.getRegionMapFactory());

      ((PartitionAttributesImpl) this.regionAttributes.partitionAttributes)
          .setCustomAttributes(this.regionAttributes.getCustomAttributes());
    }
  ...
  private static class RegionAttributesImpl<K, V> extends UserSpecifiedRegionAttributes<K, V>
    ...
    String regionMapFactory = null;
    CustomRegionAttributes customAttributes = null;
    ...
    public String toString() {
      ...
      if (hasRegionMapFactory()) {
        buf.append("; RegionMapFactory=").append(regionMapFactory);
      }
      if (hasCustomAttributes()) {
        buf.append("; customAttributes=").append(customAttributes);
      }
      return buf.toString();
    }
    ...
    @Override
    public String getRegionMapFactory() {
      return this.regionMapFactory;
    }

    @Override
    public CustomRegionAttributes getCustomAttributes() {
