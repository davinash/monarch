...
public class GatewaySenderEventImpl
  ...
  /**
   * Represents the Value stored in the Region after specific merge opeation
   */
  ...
  public GatewaySenderEventImpl(EnumListenerEvent operation, CacheEvent ce, Object substituteValue,
    ...
    this.opInfo = event.getOpInfo();
    this.ampoolValue = event.getAmpoolValue();
  }
  ...
  protected GatewaySenderEventImpl(GatewaySenderEventImpl offHeapEvent) {
    ...
    this.opInfo = offHeapEvent.getOpInfo();
    this.ampoolValue = offHeapEvent.getAmpoolValue();
  }
  ...
  public String toString() {
    ...
    buffer.append("SenderEventImpl[").append("id=").append(this.id).append(";action=")
        ...
        .append(";MOpInfo=").append(this.opInfo).append("]");
  ...
  public void setAmpoolValue(Object value) {
    this.ampoolValue = value;
  }

  public Object getAmpoolValue() {
    return this.ampoolValue;
  }
