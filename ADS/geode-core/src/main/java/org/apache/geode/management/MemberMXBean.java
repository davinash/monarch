...
public interface MemberMXBean {
   ...
   */
  public String[] listTables(int... regionDataOrders);

  /**
   * Returns the list of all available tier-stores on the system.
   *
   * @param args the arguments, if any
   * @return the unique list of all tier-stores on the system
   */
  public String[] listTierStores(int args);
