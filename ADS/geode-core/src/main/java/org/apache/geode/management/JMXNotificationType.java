...
public interface JMXNotificationType {
  ...
  /**
   * Notification type which indicates that a tier store has been created <BR>
   * The value of this type string is <CODE>distributedsystem.cache.tier.created</CODE>.
   */
  public static final String TIER_STORE_CREATED =
      DistributionConfig.GEMFIRE_PREFIX + "distributedsystem.cache.tier.created";
