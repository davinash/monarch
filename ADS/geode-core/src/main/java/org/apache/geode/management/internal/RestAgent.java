...
public class RestAgent {
  ...
  public void startHttpService() {
    ...
    final String gemfireAPIWar = agentUtil.findWarLocation("ampool-web-api");
    ...
    try {
      ...
      if (isRunningInTomcat()) {
        logger.warn(
            "Detected presence of catalina system properties. HTTP service will not be started. To enable the GemFire Developer REST API, please deploy the /ampool-web-api WAR file in your application server.");
        ...
        this.httpServer = JettyHelper.addWebApplication(httpServer, "/ampool-api", gemfireAPIWar);
