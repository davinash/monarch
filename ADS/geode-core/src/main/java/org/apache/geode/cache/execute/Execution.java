...
public interface Execution {
  ...
  Execution withTableSplitId(int tableSplitId);

  Execution withTableRowKey(byte[] rowKey);

  Execution withinTableKeyRange(byte[] startKey, byte[] stopKey);

  Execution forCoProcessor();
}
