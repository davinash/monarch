 ...
 * {@link CacheFactory#create}. This class should not be confused with the
...
public abstract class DistributedSystem implements StatisticsFactory {
   ...
   * and render the {@link Cache Cache} and all distributed collections obtained from this
   * distributed system inoperable. After a disconnect has completed, a VM may connect to another
   * distributed system.
   *
   * <P>
   *
