...
public class FileResult implements Result {
  ...
  public String toString() {
    return "FileResult{" + "filePaths=" + Arrays.toString(filePaths) + ", fileIndex=" + fileIndex
        + ", status=" + status + ", localFileData=" + Arrays.toString(localFileData)
        + ", failedToPersist=" + failedToPersist + '}';
  }
}
