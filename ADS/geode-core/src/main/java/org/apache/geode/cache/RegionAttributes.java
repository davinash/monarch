...
public interface RegionAttributes<K, V> {
  ...
  /**
   * get the region map factory classname associated with this region
   *
   * @return FQCN for the region map factory
   */
  String getRegionMapFactory();

  /**
   * get the Custom Attributes associated with this region if any
   *
   * @return CustomRegionAttributes instance
   */
  CustomRegionAttributes getCustomAttributes();
