...
public class ExecuteRegionFunction66 extends BaseCommand {
  ...
  private void authorizeRegionFunctions(Function functionObject, String regionName)
      throws Exception {
    if (functionObject instanceof TableIsEmptyFunction) {
  ...
  public void cmdExecute(Message msg, ServerConnection servConn, long start) throws IOException {
    ...
    try {
      ...
      authorizeRegionFunctions(functionObject, regionName);
