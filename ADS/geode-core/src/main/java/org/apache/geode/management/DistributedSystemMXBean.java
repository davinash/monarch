...
public interface DistributedSystemMXBean {
   ...
   * Geode regions, indicated by the default (0) region- data-order.
   *
   * @return a list of all Ampool table names hosted on the system
   */
  public String[] listAllTablePaths(String... regionDataOrders);
