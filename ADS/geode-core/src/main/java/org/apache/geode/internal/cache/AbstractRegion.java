...
public abstract class AbstractRegion implements Region, RegionAttributes, AttributesMutator,
  ...
  protected String regionMapFactory;
  protected CustomRegionAttributes customAttributes;
  ...
  private void setAttributes(RegionAttributes attrs, String regionName,
    ...
    if (this.regionMapFactory != null && pa != null) {
      PartitionAttributesImpl impl = (PartitionAttributesImpl) pa;
      impl.setRegionMapFactory(this.regionMapFactory);
    }
    if (pa != null) {
      PartitionAttributesImpl impl = (PartitionAttributesImpl) pa;
      impl.setCustomAttributes(this.customAttributes);
      impl.setScanCount(PartitionAttributesFactory.SCAN_COUNT_DEFAULT);
    }
