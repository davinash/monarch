...
public class RowFilter extends CompareFilter {
  ...
  private static final long serialVersionUID = 4790806278263015814L;
   ...
   */
  public RowFilter(CompareOp compareOp, String value) {
   ...
   * @param value
   */
  public RowFilter(CompareOp compareOp, byte[] value) {
    super(compareOp, value);
  }
  ...
  public boolean filterRowKey(Row result) {
    ...
    if (!doCompare(this.compareOp, targetValue, objectType, Bytes.toBytes("rowkey"))) {
