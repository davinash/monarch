...
DROP TABLE IF EXISTS data_types_external;
create external table data_types_external (
col_tinyint tinyint,
...
col_date date
  ...
  "monarch.locator.host"="localhost", "monarch.locator.port"="10334", "monarch.redundancy"="1", "monarch.table.type"="unordered");