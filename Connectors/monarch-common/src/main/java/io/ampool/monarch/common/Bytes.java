...
public class Bytes {
     ...
     */
    public static <T> java.util.NavigableMap<byte[], T> immutableSortedMapOf(byte[] key, T value) {
     ...
     * @return instance of {@link NavigableMap}
     */
    public static <T> java.util.NavigableMap<byte[], T> immutableSortedMapOf(byte[] key1, T value1,
                                                                             byte[] key2, T value2) {
