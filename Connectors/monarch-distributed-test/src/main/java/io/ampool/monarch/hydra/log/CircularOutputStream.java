...
public class CircularOutputStream extends OutputStream {
  ...
  /**
   *  Implements {@link OutputStream#close}.
   */
  /*
  public void close() {
    this.raf.close();
  ...
  */
  /**
   *  Implements {@link OutputStream#flush}.
   */
  /*
  public void flush() {
  }
  */
  /**
   *  Implements {@link OutputStream#write(byte[])}.
   */
  @Override
  ...
  /**
   *  Implements {@link OutputStream#write(byte[],int,int)}.
   */
  @Override
  ...
  /**
   *  Implements {@link OutputStream#write(int)}.
   */
  @Override
