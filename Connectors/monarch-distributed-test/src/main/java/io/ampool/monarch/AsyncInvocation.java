...
import io.ampool.monarch.common.InternalMonarchError;
...
public class AsyncInvocation extends Thread {
  ...
  public boolean exceptionOccurred() {
    if (this.isAlive()) {
      throw new InternalMonarchError("Exception status not available while thread is alive.");
    }
  ...
  public Object getReturnValue() {
    if (this.isAlive()) {
      throw new InternalMonarchError("Return value not available while thread is alive.");
    }
    return this.returnedObj;
  }
