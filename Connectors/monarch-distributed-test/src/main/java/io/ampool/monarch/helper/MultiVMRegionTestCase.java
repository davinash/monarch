...
public abstract class MultiVMRegionTestCase extends CacheTestCase {
...
//              org.apache.geode.internal.GemFireVersion.waitForJavaDebugger(getLogWriter());
  ...
  *//**//**
   ...
   *//**//*
  public void testDefinedEntryUpdated() throws RMIException {
    final String name = this.getUniqueName();
    final Object key = "KEY";
    final Object oldValue = "OLD_VALUE";
    final Object newValue = "NEW_VALUE";
...
//DebuggerSupport.waitForJavaDebugger(getLogWriter(), " about to get");
  ...
  *//**//**
   ...
   *//**//*
  public void testRemoteCacheListener() throws InterruptedException, RMIException {
    assertTrue(getRegionAttributes().getScope().isDistributed());
...
//    final Object value2 = "VALUE2";
  ...
  *//**//**
   ...
   *//**//*
  public void testRemoteCacheLoader() throws InterruptedException, RMIException {
    if (!supportsNetLoad()) {
      return;
    }
    assertTrue(getRegionAttributes().getScope().isDistributed());
...
// DebuggerSupport.waitForJavaDebugger(getLogWriter());
  ...
  *//**//**
   ...
   *//**//*
  public void testRemoteCacheWriter() throws InterruptedException, RMIException {
    assertTrue(getRegionAttributes().getScope().isDistributed());
...
//   }
  ...
  *//**//**
   ...
   *//**//*
  public void testMirroredLocalLoad() throws RMIException {
    if (!supportsReplication()) {
      return;
    }
    final String name = this.getUniqueName();
