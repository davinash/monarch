...
import io.ampool.monarch.RemoteDUnitVMIF;
...
public class ProcessManager {
  ...
  private String[] buildJavaCommand(int vmNum, int namingPort) {
    ...
    /*
     * Include jar files from the location, if any, in DUnit VMs.. for the
     * cases where different version of jar is needed for client and servers.
     * like the HiveRunner needs hive-exec-0.14 but Servers need hive-exec-2.x.
     */
    final String useJars = System.getProperty("server.use.jar");
    classPath = useJars != null ? useJars + System.getProperty("path.separator") + classPath : classPath;
    ...
    return new String[] {
        ...
        "-ea",
        agent,
        "io.ampool.monarch.standalone.ChildVM"
    };
  }
