...
import io.ampool.monarch.helper.CacheSerializableRunnable;
import io.ampool.monarch.helper.DistributedTestCase;
...
//    getLogWriter().info("after TestCacheCreation");
  ...
  protected void closeAllCache() throws RMIException {
    closeCache();
  ...
  public void sendUnorderedMessageToAll() {
    ...
    try {
      org.apache.geode.distributed.internal.HighPriorityAckedMessage msg = new org.apache.geode.distributed.internal.HighPriorityAckedMessage();
...
//  }
  ...
  public static void cleanDiskDirs() throws IOException {
    org.apache.geode.internal.FileUtil.delete(getDiskDir());
    ...
    for(File file: defaultStoreFiles) {
      org.apache.geode.internal.FileUtil.delete(file);
    }
  }
}
