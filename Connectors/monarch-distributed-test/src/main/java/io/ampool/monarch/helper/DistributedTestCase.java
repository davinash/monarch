...
public class DistributedTestCase extends TestCase implements Serializable {
  ...
  public void attachDebugger(VM vm, final String msg) throws RMIException {
    vm.invoke(new SerializableRunnable("Attach Debugger") {
      public void run() {
        org.apache.geode.internal.util.DebuggerSupport.waitForJavaDebugger(msg);
// Method changed in M2 waitForJavaDebugger(getSystem().getLogWriter().convertToLogWriterI18n(), msg);
      }
    });
  }
   ...
   */
  public static void invokeInEveryVM(SerializableRunnable work) throws RMIException {
  ...
  public static void invokeInLocator(SerializableRunnable work) throws RMIException {
   ...
   */
  protected static Map invokeInEveryVM(SerializableCallable work) throws RMIException {
   ...
   */
  protected static void invokeInEveryVM(Class c, String method) throws RMIException {
    for (int h = 0; h < Host.getHostCount(); h++) {
      Host host = Host.getHost(h);
   ...
   * @see VM#invoke(Class, String)
   */
  protected static void invokeInEveryVM(Class c, String method, Object[] methodArgs) throws RMIException {
    for (int h = 0; h < Host.getHostCount(); h++) {
      Host host = Host.getHost(h);
  ...
  protected void invokeRepeatingIfNecessary(VM vm, RepeatableRunnable task) throws RMIException {
   ...
   * @see VM#invoke(Runnable)
   */
  protected void invokeInEveryVMRepeatingIfNecessary(RepeatableRunnable work) throws RMIException {
    for (int h = 0; h < Host.getHostCount(); h++) {
      Host host = Host.getHost(h);
  ...
  /** print a stack dump for the given vm
   ...
   @since 5.0
   */
  public static void dumpStack(VM vm) throws RMIException {
  ...
  /** print stack dumps for all vms on the given host
   ...
   @since 5.0
   */
  public static void dumpStack(Host host) throws RMIException {
    for (int v=0; v < host.getVMCount(); v++) {
  ...
  /** print stack dumps for all vms
   ...
   @since 5.0
   */
  public static void dumpAllStacks() throws RMIException {
    for (int h=0; h < Host.getHostCount(); h++) {
   ...
   */
  public boolean crashDistributedSystem(VM vm) throws RMIException {
...
//    System.setProperty(HoplogConfig.ALLOW_LOCAL_HDFS_PROP, "true");
  ...
  public static void cleanupAllVms() throws RMIException {
    cleanupThisVM();
  ...
  private static void cleanupThisVM() throws RMIException {
    closeCache();
  ...
  public static void unregisterAllDataSerializersFromAllVms() throws RMIException {
  ...
  protected static void disconnectAllFromDS() throws RMIException {
    disconnectFromDS();
...
//          );
  ...
  public static class ExpectedException implements Serializable {
    ...
    public void remove() throws RMIException {
   ...
   */
  public static ExpectedException addExpectedException(final String exception) throws RMIException {
